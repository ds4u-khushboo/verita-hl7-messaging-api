...
public class TwilioTest {
    ...
    @Autowired
    private TwillioService twilioService; // Service to handle Twilio integration
...
//    private String getPatientPhoneNumber(Long patientId) {
//        // Logic to fetch patient's phone number based on patient ID
//        // This may involve querying the database or service call
